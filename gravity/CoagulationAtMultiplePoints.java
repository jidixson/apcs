...
public class TwoMassesWithNormalForce {
	...
	public static void main(String[] args) {
		...
		Mass m1 = new Mass(350, 300, 100, "red");
		m1.setRadius(20);
		Mass m2 = new Mass(450, 300, 100, "blue");
		m2.setRadius(20);
		...
		while (true) {
			...
			if (m1.isTouching(m2)) {
				m1.accelerate(m1.normalForce(m2));
				m2.accelerate(m2.normalForce(m1));
			}
			else {
